...
class TelefoniaHistorialController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $historial=new TelefoniaHistorial();
        $historial->create([
    ...
    public function edit($id)
    {
        ...
        $historial=TelefoniaHistorial::where("id_dispositivo","=",$id)->where('fecha_dev','like','0001-01-01')->first();
         //dd($historial);
        return view('historialestel.entregar',['historial'=>$historial,'dispositivo'=>$dispositivo]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $historial = TelefoniaHistorial::find($id);
        ...
        $dispositivo= Telefonia::find($id_d);
