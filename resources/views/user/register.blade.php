            ...
            <div class="card col-md-9 mb-4" style="background-color:  #5B962F">
                <form action="/register" method="POST" class="align-items-center validar">
                    ...
                    <div class="divider d-flex align-items-center mt-4 my-4">
                        <h3 class="text-center fw-bold mx-3 mb-0" style="color:#fff">Crear Cuenta</h3>
                    </div>
                    <p class="text-center fw-bold mx-3 mb-4" style="color:#fff">¿Tienes una cuenta? <a
                        style="color:#fff" href="/login">Inicia Sesión</a></p>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-outline ">
                                <label class="form-label tex mt" for="name">Nombre</label>
                                @error('name')
                                    <br>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-outline ">
                                <label class="form-label tex" for="telefono">Número</label>
                                @error('telefono')
                                    <br>
                                    <small style="color: #fff !important">*{{ $message }}</small>
                                    <br>
                                ...
                                <input type="number" name="telefono" id="telefono"
                                    class="form-control cajita form-control-lg" placeholder="Ingrese su número telefónico"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-outline mb-3">
                                ...
                                <input type="password" name="password" id="password"
                                    class="form-control cajita form-control-lg" placeholder="Ingrese su Contraseña"
                                    required value="{{ old('password') }}" />
                                       <!-- Botón para mostrar/ocultar la contraseña -->
                                       <label class="form-label tex mt-2" for="password">Ver contraseña  <button type="button" id="togglePassword" class="btn mt-2 ml-2 btn-sm btn-danger2">
        <i class="fas fa-eye"></i>     </button></label>
                            ...
                            <div class="form-outline mb-3">
                                <label class="form-label tex mt-2" for="password">Confirmar contraseña</label>
