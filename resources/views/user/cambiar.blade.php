    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
        ...
        <div class=" card col-md-8 col-lg-6 mb-4 col-xl-4 offset-xl-1"
            style="background-color:  #5B962F">
                <form action="/reset-password" method="POST" class="align-items-center validar">
                    @method('POST')
                    @csrf
                    @include('mensaje')
                    ...
                    <input class="hide" type="hidden" name="token" value="{{ $token }}">
                    <div class="form-outline mb-4">
                        @error('email')
                            ...
                            <br>
                        @enderror
                        <input type="email" name="email" id="email" class="form-control form-control-lg cajita"
                            placeholder="Ingrese su Correo Electrónico"required value="{{ $email ?? old('email') }}"
                            autofocus/>
                        <label class="form-label mt-2 tex" for="email">Correo Electrónico</label>
                    </div>
                    <!-- Password input -->
                    ...
                    <div class="form-outline mb-3">
                        ...
                        <label class="form-label mt-2 tex" for="password_confirmation">Confirma la Contraseña             <button type="button" id="togglePassword" class="btn mt-2 ml-2 btn-sm btn-danger2">
