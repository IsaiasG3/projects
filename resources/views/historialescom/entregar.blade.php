    ...
    <form class="col s12" method="POST" action="/historial/{{$historial->id}}" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="input-field col s6" style="margin-top: 50px">
              <input id="fecha_dev" name="fecha_dev" type="date"  min="2000-01-01"
              max="2300-12-31" class="validate" value="{{old('fecha_dev')}}"  required>
          ...
          <div class="row">
            <div class="input-field col s6">
              <input  id="fallas" name="fallas"type="text" class="validate" value="{{old('fallas')}}" required>
        ...
        <div class="row card">
            ...
            <div class="input-field col s6">
              <input id="foto_dev4" name="foto_dev4" type="file" class="validate" value="{{old('foto_dev4')}}"accept="image/*" required>
              @error('foto_dev4')
                <small>{{$message}}</small>
              @enderror
